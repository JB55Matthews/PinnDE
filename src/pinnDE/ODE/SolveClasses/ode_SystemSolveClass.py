...
class ode_systemSolution:
    ...
    def __init__(self, eqn, inits, t_bdry, N_pde, epochs, order, net_layers, net_units, constraint, model, flag):
        ...
        self._solutionPred = self._model(np.expand_dims(self._t, axis=1))
    ...
    def plot_ivp_loss(self, filetitle = "ODE-IVP-Loss"):
        """
    ...
    def plot_solution_prediction(self, filetitle = "ODE-solution-pred"):
        ...
        Args:
            filetitle (string): Title of saved file
        """
        ode_Plotters.plot_solution_prediction_system(self._t, self._solutionPred, filetitle)
        return
    ...
    def plot_predicted_exact(self, exact_eqn, filetitle = "ODE-SolPred-Exact"):
        ...
        ode_Plotters.plot_predicted_exact_system(self._t, self._solutionPred, exact_outs, filetitle)
        return