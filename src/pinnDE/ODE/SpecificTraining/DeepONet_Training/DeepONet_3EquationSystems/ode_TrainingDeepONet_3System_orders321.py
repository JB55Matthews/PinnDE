...
def defineCollocationPoints(t_bdry, N, sensor_range):
  ...
  zsensors = np.random.uniform(float(sensor_range[0]), float(sensor_range[1]), size=(N, 6))
...
def train_step(params, pdes, z, orders_case):
  ...
  def loss(params, t, z, orders_case):
    if (orders_case == 1): #u, x, y -> u, x, y
    ...
    elif (orders_case == 4): #u, x, y -> x, u, y
      u = w0(t, z, int(eqn2[-1]), params)
    ...
    elif (orders_case == 5): #u, x, y -> y, x, u
      ...
      ytt = w_tt(t, z, int(eqn1[-1]), params)
      yttt = w_ttt(t, z, int(eqn1[-1]), params)
    elif (orders_case == 6): #u, x, y -> x, y, u
      u = w0(t, z, int(eqn3[-1]), params)
      x = w0(t, z, int(eqn1[-1]), params)
      y = w0(t, z, int(eqn2[-1]), params)
      ut = w_t(t, z, int(eqn3[-1]), params)
