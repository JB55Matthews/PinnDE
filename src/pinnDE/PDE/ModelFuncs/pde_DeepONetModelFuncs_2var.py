...
def select_DeepONet_tx(t_bdry, x_bdry, t_order, initial_t, net_layers, net_units, constraint, setup_boundries, N_iv):
    """
  ...
  """
    ...
    if boundary_type == "periodic_timeDependent":
        if constraint == "soft":
            model = build_DeepONet_periodic_tx(net_layers, net_units, N_iv, t_bdry)
        elif constraint == "hard":
            if t_order == 1:
                model = build_DeepONet_periodic_tx_hard1(net_layers, net_units, N_iv, t_bdry, initial_t[0])
            elif t_order == 2:
                model = build_DeepONet_periodic_tx_hard2(net_layers, net_units, N_iv, t_bdry, initial_t[0], initial_t[1])
            elif t_order == 3:
                model = build_DeepONet_periodic_tx_hard3(net_layers, net_units, N_iv, t_bdry, initial_t[0], initial_t[1], initial_t[2])
...
def select_DeepONet_xy(x_bdry, y_bdry, net_layers, net_units, constraint, setup_boundries, N_bc):
  """
  Main function called by solve class to select which model is needed in training, and calls that build_model function.
  ...
  if boundary_type == "dirichlet_timeIndependent":
    if constraint == "soft":
      model = build_DeepONet_standard(net_layers, net_units, N_bc, x_bdry, y_bdry)
        ...
        model = build_DeepONet_dirichlet_hardconstraint_xy(net_layers, net_units, N_bc, x_bdry, y_bdry,setup_boundries[3], setup_boundries[4],
                                             setup_boundries[5], setup_boundries[6])
  elif boundary_type == "neumann_timeIndependent":
    if constraint == "soft":
      model = build_DeepONet_standard(net_layers, net_units, N_bc, x_bdry, y_bdry)
         
  elif boundary_type == "periodic_timeIndependent":
    model = build_DeepONet_periodic_xy(net_layers, net_units, N_bc)
...
class PeriodicBCs(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        return tf.concat((tf.cos(inputs), tf.sin(inputs)), axis=1)
...
def build_DeepONet_periodic_tx_hard1(n_layers, n_units, N_iv, t_bdry, u0):
    """
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_tx with periodic boundries, hard constraints of a 
...
def build_DeepONet_periodic_tx_hard2(n_layers, n_units, N_iv, t_bdry, u0, ut0):
    """
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_tx with periodic boundries, hard constraints of a 
...
def build_DeepONet_periodic_tx_hard3(n_layers, n_units, N_iv, t_bdry, u0, ut0, utt0):
    """
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_tx with periodic boundries, hard constraints of a 
...
def build_DeepONet_periodic_tx(n_layers, n_units, N_iv, t_bdry):
    """
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_tx with periodic boundries and soft constraints</li>
    </ul>
...
def build_DeepONet_standard(n_layers, n_units, N, t_bdry, x_bdry):
    ...
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_tx with dirichlet boundries and soft constraints</li>
    <li>solvePDE_DeepONet_tx with neumann boundries and soft constraints</li>
    <li>solvePDE_DeepONet_xy with dirichlet boundries and soft constraints</li>
    <li>solvePDE_DeepONet_xy with neumann boundries and soft constraints</li>
    </ul>
    ...
    Args:
        ...
        N (int): N_iv or N_bc, Number of randomly sampled collocation points along initial t 
            or number of randomly sampled collocation points along boundries.
...
def build_DeepONet_periodic_xy(n_layers, n_units, N_bc):
    """
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_xy with periodic boundries and soft constraints</li>
    <li>solvePDE_DeepONet_xy with periodic boundries and hard constraints</li>
    </ul>
...
def build_DeepONet_dirichlet_hardconstraint_xy(n_layers, n_units, N_bc, x_bdry, y_bdry, xleft_bound, 
    ...
    Used in solving:
    <ul>
    <li>solvePDE_DeepONet_xy with dirichlet boundries and hard constraints</li>
    </ul>
