...
def select_model_txy(t_bdry, x_bdry, y_bdry, t_order, inital_t, net_layers, net_units, constraint, setup_boundries):
  boundary_type = setup_boundries[0]
  ...
  #   elif constraint=="hard":
  #     if t_order == 1:
  #       model = build_model_dirichlet_hardconstraint1_tx(t_bdry, x_bdry, inital_t[0], net_layers, net_units, setup_boundries[3], setup_boundries[4])
