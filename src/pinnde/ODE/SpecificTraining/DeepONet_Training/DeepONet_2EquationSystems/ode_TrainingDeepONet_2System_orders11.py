...
class DeepONet(nn.Module):
  ...
  def __call__(self, t, u):
    ...
    trunk_x2 = trunk_net[:,self.units:]

    branch_x1 = branch_net[:,:self.units]
    branch_x2 = branch_net[:,self.units:]
...
def startTraining(eval_points, inits, order, t, N_sensors, sensor_range, epochs, net_layers, net_units, eqns):
  ...
  params = deeponet.init(jax.random.PRNGKey(0), jnp.ones((10,)), jnp.ones((10,2)))
