...
from ..pde_Points import defineCollocationPoints_DON_xy
...
class pde_don_xy_solution:
    ...
    def __init__(self, eqn, setup_boundries, x_bdry, y_bdry, N_pde, N_sensors, 
        ...
        if setup_boundries[0] == "periodic_timeIndependent":
            self._N_bc = 100
        else:
            self._N_bc = setup_boundries[2]

        self._model = select_DeepONet_xy(x_bdry, y_bdry, net_layers, net_units, 
                                                                constraint, setup_boundries, self._N_bc)
        
        self._pde_points, self._usensors = defineCollocationPoints_DON_xy(x_bdry, y_bdry, 
        ...
        self._sensor_range, self._setup_boundries, self._model, self._constraint, extra_ders, self._flag)
