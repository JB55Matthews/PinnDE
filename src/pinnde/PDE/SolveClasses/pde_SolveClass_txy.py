...
class pde_txy_solution:
    ...
    def __init__(self, eqn, t_order, initial_t, setup_boundries, t_bdry, x_bdry, y_bdry, N_pde, N_iv, 
        ...
        if self._model == None:
            self._model = select_model_txy(t_bdry, x_bdry, y_bdry, t_order, initial_t, net_layers, net_units, constraint, setup_boundries)
        ...
        self._N_iv, self._setup_boundries, self._model, self._constraint, self._flag)
