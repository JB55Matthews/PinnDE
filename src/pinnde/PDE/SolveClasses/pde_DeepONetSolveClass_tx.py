...
from ..pde_Points import defineCollocationPoints_DON_tx
...
class pde_don_tx_solution:
    ...
    def __init__(self, eqn, t_order, initial_t, setup_boundries, t_bdry, x_bdry, N_pde, N_iv, N_sensors, 
                 sensor_range, epochs, net_layers, net_units, constraint, extra_ders, flag):
        """
        ...
        self._model = select_DeepONet_tx(t_bdry, x_bdry, t_order, initial_t, net_layers, net_units, 
                                                                constraint, setup_boundries, N_iv)
        
        self._pde_points, self._init_points, self._usensors = defineCollocationPoints_DON_tx(t_bdry, x_bdry, initial_t, t_order, 
                                                                                     N_pde, N_iv, N_sensors, sensor_range)
        ...
        self._sensor_range, self._setup_boundries, self._model, self._constraint, self._extra_ders, self._flag)
        ...
        x = np.linspace(self._x_bdry[0], self._x_bdry[1], m)
