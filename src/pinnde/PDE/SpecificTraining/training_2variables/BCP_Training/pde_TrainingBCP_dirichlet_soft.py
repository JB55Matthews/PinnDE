...
def PINNtrain(pde_points, setup_boundries, epochs, eqn, N_pde, model, extra_ders):
    """
    Main function called by PINNtrainSelect_xy when solving equation in xy with dirichlet boundries with soft constraint.
